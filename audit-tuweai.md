...
- ✅ corregido parcialmente: `eslint.config.mjs` ahora expone `@typescript-eslint/no-explicit-any` en modo `warn`, congelando el ingreso silencioso de nueva deuda de tipado mientras se cierra el inventario remanente.

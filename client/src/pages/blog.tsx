...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "8 min",
    tags: ["SEO", "Velocidad Web", "Core Web Vitals"],
    likes: 175,
    views: 4120
  },
  {
    id: 4,
    title: "El secreto de los emails con alta tasa de apertura",
    excerpt: "Aprende a crear asuntos de email irresistibles y contenido que tus suscriptores realmente quieran leer.",
    category: "Email Marketing",
    date: "1 de abril, 2025",
    author: "Ana Torres",
    authorImage: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    image: "https://images.unsplash.com/photo-1557200134-90327ee9fafa?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    readTime: "4 min",
    tags: ["Email Marketing", "Copywriting", "Conversión"],
    likes: 67,
    views: 1890
  },
  {
    id: 5,
    title: "Cómo automatizar tu embudo de ventas con HubSpot",
    excerpt: "Una guía paso a paso para implementar la automatización de marketing y aumentar la eficiencia de tu proceso comercial.",
    ...
    readTime: "7 min",
    tags: ["Automatización", "HubSpot", "Embudos de Venta"],
    likes: 112,
    views: 2760
  },
  {
    id: 6,
    title: "Landing pages de alta conversión: Elementos clave",
    excerpt: "Los 7 elementos esenciales que toda landing page efectiva debe incluir para maximizar las conversiones.",
    category: "Conversión",
    date: "24 de marzo, 2025",
    author: "Laura González",
    authorImage: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    image: "https://images.unsplash.com/photo-1519222970733-f546218fa6d7?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    readTime: "5 min",
    tags: ["Landing Pages", "Conversión", "CRO"],
    likes: 84,
    views: 2230
  },
  {
    id: 7,
    title: "Google Analytics 4: La guía definitiva para 2025",
    excerpt: "Todo lo que necesitas saber para sacar el máximo provecho de GA4 y tomar decisiones basadas en datos.",
    category: "Analítica",
    date: "20 de marzo, 2025",
    author: "Miguel Serrano",
    authorImage: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80",
    image: "https://images.unsplash.com/photo-1607798748738-b15199a9a458?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    readTime: "9 min",
    tags: ["Google Analytics", "Analítica Web", "Datos"],
    likes: 138,
    views: 3850
  },
  {
    id: 8,
    title: "Estrategias de remarketing avanzadas para e-commerce",
    excerpt: "Técnicas probadas para recuperar clientes potenciales y aumentar las conversiones en tu tienda online.",
    category: "E-commerce",
    ...
    readTime: "6 min",
    tags: ["E-commerce", "Remarketing", "Publicidad Digital"],
    likes: 92,
    views: 2560
  }
];

// Generador de URL de artículo basado en el ID del post
const getArticleUrl = (postId: number) => {
  switch (postId) {
    case 1:
      return '/blog-article/aumentar-tasa-conversion';
    case 2:
      return '/blog-article/tendencias-diseno-web';
    case 3:
      return '/blog-article/seo-tecnico-optimizar-velocidad';
    default:
      return '/blog';
  }
};
...
const BlogCard: React.FC<{ post: BlogPost; delay: number }> = ({ post, delay }) => {
  const [isHovered, setIsHovered] = useState(false);
  const navigate = useNavigate();
  
  const handleClick = () => {
    navigate(getArticleUrl(post.id));
  };
  
  return (
    <>
      <motion.div
        className="bg-[#121217] rounded-xl overflow-hidden shadow-lg border border-gray-800 h-full flex flex-col group cursor-pointer"
      ...
      >
        <div className="h-48 overflow-hidden relative">
          ...
          <div className="absolute bottom-0 left-0 p-4 flex items-center">
            <div className="flex space-x-3 items-center">
              <span className="text-xs text-white bg-[#00CCFF]/30 px-2 py-1 rounded-full backdrop-blur-sm">
                {post.readTime}
              </span>
        ...
        <div className="p-6 flex-grow flex flex-col">
          <div className="flex justify-between items-center mb-3">
            <span className="text-sm px-3 py-1 bg-[#00CCFF]/10 text-[#00CCFF] rounded-full">{post.category}</span>
            {post.comments && (
          ...
          <h3 className="font-rajdhani font-bold text-xl mb-2 text-white group-hover:text-[#00CCFF] transition-colors">{post.title}</h3>
          ...
          <div className="flex justify-between items-center mt-auto pt-4 border-t border-gray-800">
            <div className="flex items-center">
              {post.authorImage ? (
                <img src={post.authorImage} alt={post.author} className="w-6 h-6 rounded-full mr-2 object-cover" />
              ) : null}
              <span className="text-gray-400 text-xs">Por {post.author}</span>
            </div>
          ...
          {post.tags && post.tags.length > 0 && (
            <div className="mt-4 flex flex-wrap gap-1">
              {post.tags.slice(0, 3).map((tag, index) => (
                <span key={index} className="text-xs text-gray-500 bg-gray-800/50 px-2 py-0.5 rounded-full">
                  #{tag}
                </span>
              ))}
              {post.tags.length > 3 && (
                <span className="text-xs text-gray-500 px-1">+{post.tags.length - 3}</span>
              )}
            </div>
          )}
        </div>
        
        <div className="absolute inset-0 flex items-center justify-center bg-[#121217]/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <Link 
            to={getArticleUrl(post.id)}
            className="px-4 py-2 bg-gradient-to-r from-[#00CCFF] to-[#9933FF] rounded-full text-white text-sm font-medium transform scale-90 group-hover:scale-100 transition-transform duration-300"
          >
            Leer artículo
          </Link>
        </div>
...
export default function Blog() {
  ...
  const uniqueCategories = blogPosts.reduce<string[]>((acc, post) => {
  ...
  // Efecto para filtrar posts basado en categoría y búsqueda
  useEffect(() => {
          ...
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Descubre artículos, guías y consejos sobre marketing digital, 
                desarrollo web y estrategias para potenciar tu presencia online.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          {filteredPosts.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-medium text-gray-400 mb-2">No se encontraron artículos</h3>
          ...
          <div className="mt-12 flex justify-center">
            <nav className="flex space-x-2">
              <a
                href="#"
                className="px-4 py-2 bg-[#121217] border border-gray-800 rounded-lg text-gray-400 hover:bg-[#1a1a23] hover:text-white transition-colors"
              >
                Anterior
              </a>
              <a
                href="#"
                className="px-4 py-2 bg-gradient-to-r from-[#00CCFF] to-[#9933FF] rounded-lg text-white"
              >
                1
              </a>
              <a
          ...
          <div className="max-w-4xl mx-auto bg-[#121217] rounded-xl p-8 border border-gray-800">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                Recibe en tu correo las últimas tendencias, guías y consejos sobre marketing digital y desarrollo web.
              </p>
            </div>

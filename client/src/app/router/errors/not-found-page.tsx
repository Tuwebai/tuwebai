  ...
  return (
    <>
      <MetaTags
        ...
        description="La página que buscás no está disponible. Volvé al inicio o consultanos para encontrar la sección correcta."
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-indigo-50 to-white">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Página no encontrada</h1>

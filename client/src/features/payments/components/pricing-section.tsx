...
export default function PricingSection({ setRef }: PricingSectionProps) {
  ...
  const handleCheckout = async (plan: PaymentPlan) => {
    try {
      ...
      const errorMessage = getPaymentsErrorMessage(error, 'Error al conectar con Mercado Pago');
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
          <PricingTier
            ...
            price="$299.000"
            period="mes"
            description="Ideal para empresas pequenas que inician su presencia digital"
            features={[
              'Sitio web de 5 paginas',
              'Optimizacion SEO basica',
              'Diseno responsive',
              'Formulario de contacto',
              'Integracion con redes sociales',
              'Soporte tecnico por 3 meses'
            ]}
            delay={1}
          ...
          <PricingTier
            ...
            price="Personalizado"
            period=""
            description="Para empresas con necesidades especificas y a gran escala"
            features={[
              'Sitio web con paginas ilimitadas',
        ...
        <div className="mt-14 text-center">
          <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
            Necesitas una solucion mas especifica? Ofrecemos planes personalizados disenados para cubrir exactamente lo que tu negocio necesita.
          </p>
